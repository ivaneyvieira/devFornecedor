...
abstract class PrintText<T> {
    ...
    fun columNumber(
            header: String, size: Int, format: String = "0", lineBreak: Boolean = false,
            process: T.() -> Double
                   ): PrintText<T> {
    ...
    protected fun String.barras(): String {
        ...
        stringBuffer.append(0x1d.toChar()).append(0x68.toChar()).append(0x50.toChar())
                .append(0x1d.toChar())
                .append(0x77.toChar()).append(0x04.toChar()).append(0x1d.toChar())
                .append(0x6b.toChar()).append(0x49.toChar())
    ...
    private fun finalize(text: StringBuilder) {
        text.append(0x0a.toChar()).append(0x0a.toChar()).append(0x0a.toChar()).append(0x1b.toChar())
                .append(0x69.toChar())
                .append(0x12.toChar())
    }
    ...
    private fun String.expandLine(): String {
        val stringBuffer = StringBuilder()
        stringBuffer.append(0x1b.toChar()).append(0x45.toChar()).append(0x01.toChar()).append(this)
                .append(0x1b.toChar())
...
data class Column<T, V>(
        val header: String, val size: Int, val lineBreak: Boolean, val process: T.() -> V,
