...
class TabFrete(val viewModel: TabFreteViewModel) : ITabFreteViewModel, ITabPanel {
  ...
  override fun setFiltro(filtro: FiltroFreteEntrada) {
  ...
  override fun getFiltro(): FiltroFreteEntrada {
    return FiltroFreteEntrada(storeno = edtLoja.value?.no ?: 0,
