...
import br.com.astrosoft.devolucao.viewmodel.entrada.ITabSubstiFcViewModel
...
class TabSubstiFc(val viewModel: TabSubstiFcViewModel) : ITabSubstiFcViewModel, ITabPanel {
  ...
  override fun openRelatorio() {
    DlgRelatorioSubstiFc(viewModel, getFiltro()).show()
  }
  ...
  override fun isAuthorized(user: IUser): Boolean {
    ...
    return username?.entradaSubstiFc == true
  }
