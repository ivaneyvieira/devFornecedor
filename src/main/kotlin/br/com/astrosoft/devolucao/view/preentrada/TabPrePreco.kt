...
import br.com.astrosoft.devolucao.viewmodel.preentrada.TabPrePrecoViewModel
...
class TabPrePreco(val viewModel: TabPrePrecoViewModel) : ITabPrePrecoViewModel, ITabPanel {
  ...
  override fun openRelatorio() {
    DlgRelatorioPrePreco(viewModel, getFiltro()).show()
  }
  ...
  override fun isAuthorized(user: IUser): Boolean {
    ...
    return username?.entradaPrePreco == true
  }
