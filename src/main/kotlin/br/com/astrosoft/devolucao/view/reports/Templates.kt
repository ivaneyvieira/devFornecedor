...
object Templates {
  val rootStyle = stl.style().setPadding(1)
  val boldStyle = stl.style(rootStyle).bold()
  val italicStyle = stl.style(rootStyle).italic()
  val boldCenteredStyle = stl.style(boldStyle).setTextAlignment(CENTER, MIDDLE)
  val bold9CenteredStyle = stl.style(boldCenteredStyle).setFontSize(9)
  val columnStyle = stl.style(rootStyle).setFontSize(8)
  ...
  val groupStyle = stl.style(boldStyle).setHorizontalTextAlignment(LEFT)
  val subtotalStyle = stl.style(boldStyle)
  val reportTemplate =
  ...
  val fieldFontTitle = stl.style(rootStyle).setFontSize(4)
  val fieldFont = stl.style(rootStyle).setFontSize(6)
  val fieldBorder = stl.style(fieldFont).setBorder(stl.penThin()).setRadius(10)
  val fieldFontGrande = stl.style(rootStyle).setFontSize(14)
}