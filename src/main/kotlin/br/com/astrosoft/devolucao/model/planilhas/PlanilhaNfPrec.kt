...
class PlanilhaNfPrec(val fiscal: Boolean) {
  private val campos: List<Campo<*, NfPrecEntrada>> =
      if (fiscal) listOf(
        ...
        CampoNumber("icmsn") { icmsn ?: 0.0 },
        CampoNumber("icmsp") { icmsp ?: 0.0 },
        CampoNumber("ipin") { ipin ?: 0.0 },
        CampoNumber("ipip") { ipip ?: 0.0 },
        CampoString("cstn") { cstn ?: "" },
        CampoString("cstp") { cstp ?: "" },
        CampoNumber("mvan") { mvanAprox ?: 0.0 },
        CampoNumber("mvap") { mvap ?: 0.0 },
      )
