...
data class ProdutoNotaEntradaNdd(
  ...
  var quantidadeAvaria: Double?
    get() {
      val quant = saci.getQuantidadeAvaria(this) ?: quantidade
      ajustaQuantidadeAvaria(quant)
      return quant
    }
    set(value) {
      saci.setQuantidadeAvaria(this, value)
      ajustaQuantidadeAvaria(value)
    }
