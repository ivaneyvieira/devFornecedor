...
class ProdutosNotaSaida(val loja: Int, val pdv: Int, val transacao: Int, val codigo: String, val refFor: String,
                        val descricao: String, val grade: String, val qtde: Int, val barcode: String, val un: String,
                        val st: String, val valorUnitario: Double, val valorTotal: Double, val invno: Int,
