...
class TabPreEntFiscalViewModel(val viewModel: PreEntradaViewModel) {
  val subView
    get() = viewModel.view.tabPreEntFiscalViewModel
...
interface ITabPreEntFiscalViewModel : ITabView {
