...
import br.com.astrosoft.devolucao.model.planilhas.PlanilhaPreRefFiscal
...
class TabPreRefFiscalViewModel(val viewModel: PreEntradaViewModel) {
  val subView
  ...
  fun geraPlanilha(notas: List<NfPrecEntrada>): ByteArray {
    val planilha = PlanilhaPreRefFiscal()
...
interface ITabPreRefFiscalViewModel : ITabView {
