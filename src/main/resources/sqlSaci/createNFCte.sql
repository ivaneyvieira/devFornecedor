...
SELECT I.storeno                                                                               AS loja,
       ...
       @PESOBRUTO := (I.weight)                                                                AS pesoBruto,
       ...
       @PESOCUB := IFNULL(@CUB * F.valorLivre2 / 100, 0.00)                                    AS pesoCub,
       IFNULL(ROUND(IF(@PESOCUB > @PESOBRUTO, @PESOCUB, @PESOBRUTO) * (F.fretePeso / 100), 2),
	      0.00)                                                                            AS fPeso,
